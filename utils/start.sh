...
test_two ()
{
    echo "\e[94m[+] Test #2: Executing your program for 5 second, please wait...\e[0m"
...
test_three ()
{
    echo "\e[94m[+] Test #3: Executing your program for 5 second, please wait...\e[0m"
